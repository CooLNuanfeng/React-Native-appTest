            ...
            <View style={styles.flex}>
                <View style={[styles.flexDirection,styles.inputHeight]}>
                    ...
                    <View style={styles.btn}>
                        <Text style={styles.search}
                            onPress={this.hide.bind(this,this.state.valule)}>
                            搜索
                        </Text>
                    </View>
                </View>
                {this.state.show ?
                    <View style={styles.result}>
                        ...
                        <Text onPress={this.hide.bind(this,this.state.value + '圆街')}
                            style={styles.item} numberOfLines={1}>
                            {this.state.value}圆街
                        </Text>
...
var TextInputApp = React.createClass({
    render : function(){
        return(
